...
class MatiereResourceIT {
    ...
    private static final TypeStructure DEFAULT_TYPE_STRUCTURE = TypeStructure.LyceeTechnique;
    private static final TypeStructure UPDATED_TYPE_STRUCTURE = TypeStructure.CentreSectoriel;
    ...
    void createMatiere() throws Exception {
        ...
        assertThat(testMatiere.getCodeRegion()).isEqualTo(DEFAULT_CODE_REGION);
        assertThat(testMatiere.getAutrecodeRegion()).isEqualTo(DEFAULT_AUTRECODE_REGION);
    ...
    void putNewMatiere() throws Exception {
        ...
        assertThat(testMatiere.getCodeRegion()).isEqualTo(UPDATED_CODE_REGION);
        assertThat(testMatiere.getAutrecodeRegion()).isEqualTo(UPDATED_AUTRECODE_REGION);
